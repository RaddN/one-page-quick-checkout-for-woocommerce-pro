 ...
 */
if (!function_exists('onepaquc_checkout_form_block_register')) {
	function onepaqucpro_checkout_form_block_register()
	{
		...
		if (WP_Block_Type_Registry::get_instance()->is_registered('wc/one-page-checkout')) {
		...
		register_block_type(
			...
			array(
				...
				'render_callback' => 'onepaqucpro_checkout_form_block_render',
				'attributes'      => array(
	...
	add_action('init', 'onepaqucpro_checkout_form_block_register', 100);
}
 ...
 * @return string HTML
 */
function onepaqucpro_checkout_form_block_render($attributes = array())
{
