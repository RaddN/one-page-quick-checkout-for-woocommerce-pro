...
class onepaqucpro_cart_anaylytics
{
    ...
    public function __construct($product_id, $analytics_api_url, $plugin_version, $plugin_name, $plugin_file = null)
    {
        ...
        if ($this->plugin_file && get_option('rmenupro_allow_analytics', 1)) {
...
?>
            <div id="onepaqucpro-plugin-deactivation-feedback" style="display:none;">
                <div class="feedback-overlay">
                    <div class="feedback-modal">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="onepaqucpro-deactivation-feedback-form">
                ...
                jQuery(document).ready(function($) {
                    ...
                    selectors.forEach(function(selector) {
                        $(selector).on('click', function(e) {
                            ...
                            $('#onepaqucpro-plugin-deactivation-feedback').show();
                        });
                    });
                    ...
                    $('#onepaqucpro-deactivation-feedback-form').on('submit', function(e) {
                        e.preventDefault();
                        ...
                        $.ajax({
                            ...
                            type: 'POST',
                            data: {
                                action: 'onepaqucpro_send_deactivation_feedback',
                    ...
                    $('.close-button').click(function() {
                        $('#onepaqucpro-plugin-deactivation-feedback').hide();
                    });
