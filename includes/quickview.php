...
class RMENUPRO_Quick_View
{
    ...
    private function add_quick_view_button()
    {
        ...
        switch ($button_position) {
            ...
            case 'after_add_to_cart':
                add_filter('woocommerce_loop_add_to_cart_link', array($this, 'onepaquc_display_quick_view_button_to_add_to_cart'), 10, 2);
                break;
            case 'image_overlay':
                add_action('wp_footer', array($this, 'display_overlay_quick_view_button_footer'), 25);
    ...
    public function onepaquc_display_quick_view_button_to_add_to_cart($link, $product)
    {
        ...
        $position = get_option('rmenupro_quick_view_button_position', 'image_overlay');
...
?>
    ...
    public function add_product_data()
    {
        ...
        echo '<div class="rmenupro-product-data" style="display:none;" data-product-info="' . esc_attr(wp_json_encode($product_data)) . '"></div>';
    }
    ...
    public function enqueue_scripts()
    {
        ...
        $mobile_optimize = get_option('rmenupro_quick_view_mobile_optimize', 0);
        ...
        wp_localize_script('rmenupro-quick-view-scripts', 'rmenupro_quick_view_params', array(
            ...
            'i18n' => array(
                ...
                'error_loading' => esc_html__('Error loading product information. Please try again.', 'one-page-quick-checkout-for-woocommerce-pro'),
            )
        ));
