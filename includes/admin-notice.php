...
add_action('admin_notices', 'onepaqucpro_cart_notice');

function onepaqucpro_cart_notice()
{
    // $page_param = onepaqucpro_get_page_parameter_from_current_url();
    // if (!get_option('onepaqucpro_api_key') && $page_param !== "onepaqucpro_cart_settings") {
    ...
    //     </div>';
    // }
    // elseif (get_option('onepaqucpro_validity_days')==="0") {
    //     echo '<div class="notice notice-success is-dismissible">
...
function onepaqucpro_get_page_parameter_from_current_url() {
