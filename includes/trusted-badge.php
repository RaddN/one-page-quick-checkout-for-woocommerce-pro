...
?>
    <div class="trust-badges-settings-wrapper">
        ...
        <table class="form-table <?php echo !onepaquc_premium_feature() ? 'pro-only' : ''; ?>">
            <tr valign="top">
                <th scope="row"><?php esc_html_e('Enable Trust Badges', 'one-page-quick-checkout-for-woocommerce'); ?></th>
                <td>
                    <label class="switch">
                        <input <?php echo !onepaquc_premium_feature() ? 'disabled' : ''; ?> type="checkbox" name="<?php echo !onepaquc_premium_feature() ? 'pro_trust_badges_enabled' : 'onepaquc_trust_badges_enabled'; ?>" value="1"
            ...
            <tr valign="top">
                ...
                <td>
                    <select <?php echo !onepaquc_premium_feature() ? 'disabled' : ''; ?> name="<?php echo !onepaquc_premium_feature() ? 'pro_trust_badge_position' : 'onepaquc_trust_badge_position'; ?>">
            ...
            <tr valign="top">
                ...
                <td>
                    <select <?php echo !onepaquc_premium_feature() ? 'disabled' : ''; ?> name="<?php echo !onepaquc_premium_feature() ? 'pro_trust_badge_style' : 'onepaquc_trust_badge_style'; ?>">
            ...
            <tr valign="top">
                ...
                <td>
                    <div class="trust-badges-container">
                            ...
                            <?php foreach ($badges as $index => $badge) : ?>
                                <div class="badge-item" data-index="<?php echo esc_attr($index); ?>">
                                    ...
                                    <div class="badge-content">
                                        <input <?php echo !onepaquc_premium_feature() ? 'disabled' : ''; ?> type="hidden" name="onepaquc_my_trust_badges_items[<?php echo esc_attr($index); ?>][enabled]"
                                            value="<?php echo !empty($badge['enabled']) ? '1' : '0'; ?>" />

                                        <p>
                                            <label><?php esc_html_e('Icon:', 'one-page-quick-checkout-for-woocommerce'); ?></label>
                                            <select <?php echo !onepaquc_premium_feature() ? 'disabled' : ''; ?> name="onepaquc_my_trust_badges_items[<?php echo esc_attr($index); ?>][icon]" class="badge-icon-select">
                        ...
                        <button <?php echo !onepaquc_premium_feature() ? 'disabled' : ''; ?> type="button" class="button button-secondary add-new-badge">
            ...
            <tr valign="top" class="custom-html-section">
                ...
                <td>
                    <p>
                        <label>
                            <input <?php echo !onepaquc_premium_feature() ? 'disabled' : ''; ?> type="checkbox" id="show-custom-html" name="show_custom_html" value="1"
                    ...
                    <div id="custom-html-editor" style="<?php echo empty(get_option('onepaquc_trust_badge_custom_html')) ? 'display:none;' : ''; ?>">
                        <textarea <?php echo !onepaquc_premium_feature() ? 'disabled' : ''; ?> name="onepaquc_trust_badge_custom_html" rows="6" class="large-text code"><?php echo esc_textarea(get_option('onepaquc_trust_badge_custom_html', '')); ?></textarea>
        ...
        <div id="badge-template" style="display:none;">
            <div class="badge-item" data-index="{{index}}">
                ...
                <div class="badge-content">
                    <input <?php echo !onepaquc_premium_feature() ? 'disabled' : ''; ?> type="hidden" name="onepaquc_my_trust_badges_items[{{index}}][enabled]" value="1" />

                    <p>
                        <label><?php esc_html_e('Icon:', 'one-page-quick-checkout-for-woocommerce'); ?></label>
                        <select <?php echo !onepaquc_premium_feature() ? 'disabled' : ''; ?> name="onepaquc_my_trust_badges_items[{{index}}][icon]" class="badge-icon-select">
                            <?php foreach ($dashicons as $icon => $name) : ?>
                    ...
                    <p>
                        <label><?php esc_html_e('Text:', 'one-page-quick-checkout-for-woocommerce'); ?></label>
                        <input <?php echo !onepaquc_premium_feature() ? 'disabled' : ''; ?> type="text" name="onepaquc_my_trust_badges_items[{{index}}][text]"
