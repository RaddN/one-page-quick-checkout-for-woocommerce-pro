...
<div class="rmenupro-cart">
    <?php 
    onepaqucpro_cart(esc_attr($atts['drawer']), esc_attr($atts['cart_icon']), esc_attr($atts['product_title_tag']), esc_attr($atts['position']), esc_attr($atts['top']), esc_attr($atts['left'])); ?>
</div>
